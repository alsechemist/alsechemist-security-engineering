...
- **ModSecurity (libmodsecurity):** The latest stable **libmodsecurity** engine is used as the Web Application Firewall (WAF) core. This engine operates independently of the web server and is integrated using official connectors.
